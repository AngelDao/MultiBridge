...
const BridgeProxyABI = [    {      "inputs": [        {          "internalType": "address",          "name": "_erc20Bridge",          "type": "address"        }      ],      "stateMutability": "nonpayable",      "type": "constructor"    },    {      "inputs": [],      "name": "bridge",      "outputs": [        {          "internalType": "contract IL1ERC20Bridge",          "name": "",          "type": "address"        }      ],      "stateMutability": "view",      "type": "function"    },    {      "inputs": [        {          "components": [            {              "internalType": "address",              "name": "_l1Token",              "type": "address"            },            {              "internalType": "address",              "name": "_l2Token",              "type": "address"            },            {              "internalType": "address",              "name": "_to",              "type": "address"            },            {              "internalType": "uint256",              "name": "_amount",              "type": "uint256"            },            {              "internalType": "uint32",              "name": "_l2Gas",              "type": "uint32"            },            {              "internalType": "bytes",              "name": "_data",              "type": "bytes"            }          ],          "internalType": "struct L1ERC20BatchBridge.DepositData[]",          "name": "_data",          "type": "tuple[]"        }      ],      "name": "depositERC20BatchTo",      "outputs": [],      "stateMutability": "nonpayable",      "type": "function"    }  ]

const iface = new ethers.utils.Interface(ABI);

const bridgeAddress = "0x22F24361D548e5FaAfb36d1437839f080363982B";

const multiBridgeProxyAddress = "0xc9E94453d182c50984A2a4afdD60796D25B027Aa"
...
const checkIfApprovedToBridge = async (token, provider) => {
    ...
    let checkAllowance = await contractWithSigner.allowance(myAddress, multiBridgeProxyAddress)
...
const getApproval = async (token, provider) => {
    ...
    let approveAllowance = await contractWithSigner.approve(multiBridgeProxyAddress, approve_amount)
...
export const multiBridge = async (callData) => {
    ...
    */
    ...
    for (var i=0; i < callData.length; i++){   
        ...
        const isApproved = await checkIfApprovedToBridge(callData[i].l1Token, provider);
